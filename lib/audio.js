 ...
 * 
 * the player will be deleted if there are no more songs in the queue
 * 
 * @param {*} msg 
 */
...
/**
 * forces the bot to leave the vc, deletes the guild's audio player, and deletes the guild's queue
 * 
 * @param {*} guildID 
 */
