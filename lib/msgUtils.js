...
export async function sendWebhookMsg(msgObj, msg, attachments, name, avatar) {
    ...
    tryWebhook(msgObj, msg, attachments, name, avatar, webhook);
}
...
export async function sendWebhookMsgUsingWebhook(msgObj, msg, attachments, name, avatar, webhook) {
    if (webhook) {
        ...
        tryWebhook(msgObj, msg, attachments, name, avatar, webhookObj);
    }
    else {
        sendWebhookMsg(msgObj, msg, attachments, name, avatar);
    }
}