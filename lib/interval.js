 ...
 */
function getMsUntilTime(hour, minute, startingHour, startingMin, interval = 1440, alreadyMiss = false) {
    ...
    if (deltaTimeMins > 0) {
        ...
        if (alreadyMiss) {
            ...
            const {
                ...
                isNow: isNowMiss
            } = getMsUntilTime(newHr, newMin, startingHour, startingMin, interval, miss);
